...
var customThemes = {
  ...
  dark: {
    ...
    background: "#111111",
    // Dark gray-black - subtle gray tint
    backgroundHover: "#1A1A1A",
    // Slightly lighter gray-black
    backgroundPress: "#222222",
    // Medium gray-black
    backgroundFocus: "#2A2A2A",
    // Lighter gray for focus
    backgroundStrong: "#333333",
    // Strong gray for emphasis
    backgroundTransparent: "rgba(17, 17, 17, 0.85)",
    color: "#F5F5F5",
    // Off-white - gentle on eyes
    colorHover: "#EEEEEE",
    // Slightly darker off-white
    colorPress: "#E5E5E5",
    // Press state off-white
    colorFocus: "#DDDDDD",
    // Focus state
    ...
    brandLight: "#F43F5E",
    brandDark: "#BE123C",
    brandSubtle: "rgba(225, 29, 72, 0.1)"
    // Subtle brand overlay for dark theme
  }
};
